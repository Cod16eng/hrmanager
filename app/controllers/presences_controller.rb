class PresencesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @presence.save
        format.html { redirect_to @presence.user, notice: 'Presence was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @presence.update(presence_params)
        format.html { redirect_to @presence.user, notice: 'Presence was successfully updated.' }
  ...
  def destroy
    @presence.destroy
    respond_to do |format|
      format.html { redirect_to @presences.user, notice: 'Presence was successfully destroyed.' }
  ...
  private
    ...
    def presence_params
      params.require(:presence).permit(:date, :hour_in, :user_id, :start_hour)
    end
end
