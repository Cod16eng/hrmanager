...
class PresencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presence" do
    assert_difference('Presence.count') do
      post presences_url, params: { presence: { date: @presence.date, hour_in: @presence.hour_in, start_hour: @presence.start_hour, user_id: @presence.user_id } }
    end
  ...
  test "should update presence" do
    patch presence_url(@presence), params: { presence: { date: @presence.date, hour_in: @presence.hour_in, start_hour: @presence.start_hour, user_id: @presence.user_id } }
